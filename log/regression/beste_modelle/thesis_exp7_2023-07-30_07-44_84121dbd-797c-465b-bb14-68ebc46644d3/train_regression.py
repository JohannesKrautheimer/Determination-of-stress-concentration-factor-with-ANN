...
def parse_args():
    ...
    parser.add_argument('--neptune_mode', choices=['sync', 'offline', 'debug'], default='offline', help='mode for neptune ai (sync, offline or debug)')
    parser.add_argument('--seed', type=int, default=None)
    parser.add_argument('--loss_fn', choices=["mae", "mse", "r2"], default='r2', help='loss function for training')
    parser.add_argument('--b1', type=float, default=0.9, help='beta 1 for Adam Optimizer')
    parser.add_argument('--tag', type=str, default='', help='neptune tag for the run')
    parser.add_argument('--data_path', type=str, default='data/weld_scans_2d_cuts_in_cm/', help='path to the location of the data')
    parser.add_argument('--set_path', type=str, default='train_test_sets/weld_scans_2d_cuts/default/', help='path to the directory with the train and test set configs')
...
def main(args):
    ...
    #If we do cross-validation, the complete test set is the same as the complete train set
    ...
    # log_string("Start of testing...")

    # test_regression.main(args)
